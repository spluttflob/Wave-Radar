...
/** @brief   Print the result(s) of a distance measurement.
 *  @details Instead of the default printout, this function prints the reading
 *           or readings in CSV format, with commas between them.
 *  @param result The distance result data structure
 */
static void print_result(acc_detector_distance_result_t *result)
{
